...
IMAGE_URI="http://homeassistant.local:5000" # URL of image to fetch. Keep in mind that the Kindle 4 does not support SSL/TLS requests
...
ROUTERIP="192.168.190.1"                  # router gateway IP. The Kindle appears to sometimes forget the gateway's IP and we need to set this manually.
